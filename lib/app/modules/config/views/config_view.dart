...
class ConfigView extends GetView<ConfigController> {
  ...
  Widget build(BuildContext context) {
    ...
    if (controller.isLoadingFirst.isFalse) {
      final host = box.read('db_host') ?? AllMaterial.baseUrl.value;
      final port = box.read('db_port') ?? AllMaterial.port.value;
      controller.hostC.text = host;
      controller.port.value = port.toString();
      controller.portC.text = port.toString();
                          ...
                          children: [
                            ...
                            Obx(
                              () => TextField(
                                ...
                                onChanged: (v) {
                                  ...
                                  AllMaterial.baseUrl.value = v;
                                },
                                decoration: _inputDecoration(
                                  label: 'Nama Server',
                                  icon: Icons.house,
                                ).copyWith(
                                  errorText: controller.hostError.value.isEmpty
                                      ? null
                                      : controller.hostError.value,
                                ),
                              ),
                            ...
                            Obx(
                              () => TextField(
                                ...
                                onChanged: (v) {
                                  ...
                                  AllMaterial.port.value = v;
                                },
                                decoration: _inputDecoration(
                                  label: 'Alamat Port',
                                  icon: Icons.settings_applications_sharp,
                                ).copyWith(
                                  errorText: controller.portError.value.isEmpty
                                      ? null
                                      : controller.portError.value,
                                ),
                              ),
                            ...
                            Obx(
                              () => TextField(
                                ...
                                obscureText:
                                    !controller.showSettingsPassword.value,
                                decoration: _inputDecoration(
                                  ...
                                  suffixIcon: IconButton(
                                    ...
                                    onPressed:
                                        controller.showSettingsPassword.toggle,
                                  ),
                                  errorText:
                                      controller.settingPassError.value.isEmpty
                                          ? null
                                          : controller.settingPassError.value,
                                ),
                              ),
