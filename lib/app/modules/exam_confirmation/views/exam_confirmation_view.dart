...
class ExamConfirmationView extends GetView<ExamConfirmationController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        var isLoading = controller.isLoadingFirst.value;
        ...
        return Scaffold(
          ...
          body: isLoading
              ? _shimmerLoadingKonfirmasiUjian()
              : Column(
                  children: [
                    Expanded(
                      child: Center(
                        child: SingleChildScrollView(
                          ...
                          child: ConstrainedBox(
                            constraints: BoxConstraints(
                                maxWidth:
                                    isDesktop ? Get.width / 2.5 : Get.width),
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    children: [
                                      Obx(
                                        () => TextField(
                                          controller: TextEditingController(
                                            text: ExamConfirmationController
                                                    .dataUjian
                                                    .value
                                                    ?.data
                                                    ?.namaUjian ??
                                      ...
                                      Obx(
                                        () => TextField(
                                          controller: TextEditingController(
                                            text:
                                                "${DateFormat('dd/MM/yyyy').format(ExamConfirmationController.dataUjian.value?.data?.tanggal ?? DateTime.now())} "
                                                "/ ${ExamConfirmationController.dataUjian.value?.data?.waktuDimulai ?? ""} "
                                                "/ ${ExamConfirmationController.dataUjian.value?.data?.durasi ?? "0"} Menit",
                                          ),
                                          readOnly: true,
                                          decoration: _inputDecoration(
                                            isDesktop: isDesktop,
                                  ...
                                  Obx(
                                    () => SizedBox(
                                      height: controller.tombolAktif.isFalse
                                          ? 10
                                          : 10,
                                    ),
                                  ),
                                  Obx(
                                    () => ElevatedButton.icon(
                                      onPressed: controller.tombolAktif.isTrue
                                          ? () {
                                              if (controller.statusUjian.value
                                                      .toLowerCase() ==
                                                  "sedang ujian") {
                                                Get.offAll(
                                                    () => ExamRoomView());
  ...
  Widget _shimmerLoadingKonfirmasiUjian() {
